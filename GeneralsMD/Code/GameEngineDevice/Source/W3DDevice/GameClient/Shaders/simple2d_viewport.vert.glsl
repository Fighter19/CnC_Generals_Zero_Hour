#version 460
// The viewport variant of simple2d uses the viewport info,
// to scale and position vertices, that were passed as pixel coordinates
...
void main()
{
    gl_Position = in_Position0 * consts.ViewportInfo_InverseExtent + consts.ViewportInfo_InverseOffset;
